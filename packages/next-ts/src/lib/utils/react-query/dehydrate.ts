...
import { QueryClient, type QueryClientConfig, type QueryKey, type QueryState, dehydrate } from '@tanstack/react-query'
import { cache } from 'react'

export const getQueryClient = cache((configs: QueryClientConfig = queryClientConfigs) => new QueryClient(configs))
