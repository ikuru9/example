...
import { RadioGroup, RadioGroupItem as BaseRadioGroupItem } from "@/components/ui/radio-group";
...
import { type Collapsible, useLayout, type Variant } from "@/context/layout-provider";
...
function DirConfig() {
  ...
  return (
    <div>
      ...
      <RadioGroup
        value={dir}
        onValueChange={(v) => setDir(v as TextDirection)}
        className="grid w-full max-w-md grid-cols-3 gap-4"
