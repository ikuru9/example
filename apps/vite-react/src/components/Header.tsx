...
export default function Header() {
  ...
  return (
    <>
      <header className="p-4 flex items-center bg-background border-b shadow-lg">
        <button
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-80 bg-card text-card-foreground shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-r ${
